...
<!-- Mirrored from htmlcooker.com/tvlgiao/everything/assets/everything/gameworld/category-two-columns-left-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Oct 2015 03:30:49 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Game World : Everything Template</title>
        ...
        <!-- Game World CSS -->
        <link rel='stylesheet' type='text/css' media='all' href='css/game-style.css' />
        <!-- Style Game World CSS -->
        <link rel='stylesheet' type='text/css' media='all' href='css/style_game.css' />
                    ...
                    <div id="em-mheader" class="visible-xs container">
                        <div id="em-mheader-top" class="row">
                            <div id="em-mheader-logo" class="col-xs-4">
                                <div class="em-logo"><a href="#" title="Game World Commerce" class="logo"><strong>Game World Commerce</strong><img src="images/logo_small.png" alt="Game World Commerce" /></a>
                                </div>
                            </div>
                            <div class="col-xs-20">
                                                ...
                                                <div class="col-sm-24">
                                                    <div class="form-language em-language-style-mobile">
                                                        <ul>
                                                            ...
                                                            <li class="">
                                                                <a href="#" title="French"> <img alt="french" src="htimages/language/french.html" /> </a>
                                                            </li>
                                                        </ul>
                                                    </div><!-- /.form-language -->
                                                                            ...
                                                                            <li class="menu-item-text menu-item-depth-1  ">
                                                                                <ul class="em-catalog-navigation vertical">
                                                                                    ...
                                                                                    <li class="level0 nav-7">
                                                                                        <a href="#"> <span>Smartphone</span> </a>
                                                                                    </li><!-- /.menu-item-vbox -->
                                                                                    <li class="level0 nav-8">
                                                                                        <a href="#"> <span>Smartphone &amp; Outdoor</span> </a>
                                                                                    </li><!-- /.menu-item-vbox -->
                                                                                    ...
                                                                                    <li class="level0 nav-11">
                                                                                        <a href="#"> <span>Home Smartphone</span> </a>
                                                                                    </li><!-- /.menu-item-vbox -->
                    ...
                    <div class="hidden-xs em-header-style29">
                        ...
                        <div class="em-header-middle">
                            <div class="container em-menu-fix-pos">
                                <div class="row">
                                    <div class="col-sm-24">
                                        <div class="em-logo f-left"><a href="#" title="Game World Commerce" class="logo"><strong>Game World Commerce</strong><img class="retina-img" src="images/logo.png" alt="Game World Commerce" /></a>
                                        </div>
                                                                                        ...
                                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                                            <div class="store-view">
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Smartphone Store" href="#"><img class="img-responsive" src="images/storeview/baby_store.jpg" alt="Smartphone Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Smartphone Store" href="#"><img class="img-responsive" src="images/storeview/garden_store.jpg" alt="Smartphone Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <p class="h5"><a href="#">Smartphone Store</a>
                                                                                            ...
                                                                                            <div class="store-view" style="padding-top:15px">
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="effect03">
                                                                                                        <div>
                                                                                                            <a title="Smartphone Store" href="#"><img class="img-responsive" src="images/storeview/sport_store.jpg" alt="Smartphone Store" />
                                                                                                            </a>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <p class="h5"><a href="#">Smartphone Store</a>
                                                                                                ...
                                                                                                <div>
                                                                                                    <ul class="em-catalog-navigation ">
                                                                                                        ...
                                                                                                        <li class="label-sale-menu">
                                                                                                            <a class="em-menu-link" href="#"> <span>Smartphone</span> </a>
                                                                                                        </li>
                                                                                                        <li>
                                    ...
                                    <div class="col-sm-18 col-sm-push-6 em-col-main">
                                        ...
                                        <div class="category-products">
                                            ...
                                            <ol class="products-list" id="products-list">
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 12" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp12_1.jpg" width="190" height="190" alt="WIASSI Version 12" /> <img id="product-collection-image-217" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp12_2.jpg" width="190" height="190" alt="WIASSI Version 12" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 12"> WIASSI Version 12 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 12" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#217" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 13" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp13_1.jpg" width="190" height="190" alt="WIASSI Version 13" /> <img id="product-collection-image-218" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp13_2.jpg" width="190" height="190" alt="WIASSI Version 13" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 13"> WIASSI Version 13 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 13" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#218" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 14" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp14_1.jpg" width="190" height="190" alt="WIASSI Version 14" /> <img id="product-collection-image-219" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp14_2.jpg" width="190" height="190" alt="WIASSI Version 14" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 14"> WIASSI Version 14 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 14" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#219" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 15" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp15_1.jpg" width="190" height="190" alt="WIASSI Version 15" /> <img id="product-collection-image-220" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp15_2.jpg" width="190" height="190" alt="WIASSI Version 15" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 15"> WIASSI Version 15 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 15" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#220" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 16" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp16_1.jpg" width="190" height="190" alt="WIASSI Version 16" /> <img id="product-collection-image-221" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp16_2.jpg" width="190" height="190" alt="WIASSI Version 16" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 16"> WIASSI Version 16 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 16" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#221" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 17" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp17_1.jpg" width="190" height="190" alt="WIASSI Version 17" /> <img id="product-collection-image-222" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp17_2.jpg" width="190" height="190" alt="WIASSI Version 17" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 17"> WIASSI Version 17 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 17" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#222" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 18" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp18_1.jpg" width="190" height="190" alt="WIASSI Version 18" /> <img id="product-collection-image-223" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp18_2.jpg" width="190" height="190" alt="WIASSI Version 18" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 18"> WIASSI Version 18 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 18" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#223" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item">
                                                    <a href="product-detail.html" title="WIASSI Version 19" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp19_1.jpg" width="190" height="190" alt="WIASSI Version 19" /> <img id="product-collection-image-224" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp19_2.jpg" width="190" height="190" alt="WIASSI Version 19" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 19"> WIASSI Version 19 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 19" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#224" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <li class="item last">
                                                    <a href="product-detail.html" title="WIASSI Version 11" class="product-image"> <img class="em-img-lazy img-responsive em-alt-hover" src="images/product/190x190/shoe_sp11_1.jpg" width="190" height="190" alt="WIASSI Version 11" /> <img id="product-collection-image-216" class="em-img-lazy img-responsive em-alt-org" src="images/product/190x190/shoe_sp11_2.jpg" width="190" height="190" alt="WIASSI Version 11" /> </a>
                                                    <div class="product-shop">
                                                        <div class="f-fix">
                                                            <h2 class="product-name"><a href="product-detail.html" title="WIASSI Version 11"> WIASSI Version 11 </a></h2>
                                                            <div class="desc std"> By popular demand, we've added half sizes to make your feet even happier. <a href="product-detail.html" title="WIASSI Version 11" class="link-learn">Learn More</a>
                                                            </div>
                                                            ...
                                                            <div class="actions">
                                                                ...
                                                                <ul class="add-to-links">
                                                                    ...
                                                                    <li><span class="separator">|</span> <a href="#216" class="link-compare" title="Add to Compare">Add to Compare</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
