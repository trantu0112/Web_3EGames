                                                ...
                                                <div class="product-img-box">
                                                    <div class="media-left">
                                                        <p class="product-image">
                                                            <a class="cloud-zoom" id="image_zoom" rel="zoomWidth: 500,zoomHeight: 500,position: 'inside'" href="public/images/product/1000x1000/5_1.jpg"> <img class="em-product-main-img" src="public/images/product/800x800/5_1.jpg" alt='' title="WIASSI Version 1" /> </a> <a id="zoom-btn" rel="lightbox[em_lightbox]" href="public/images/product/1000x1000/5_1.jpg" title="WIASSI Version 1">Zoom</a>
                                                        </p>
                                                    </div><!-- /.media-left -->
                                                    <div class="more-views">
                                                        <ul class="em-moreviews-slider">
                                                            <li class="item">
                                                                <a class="cloud-zoom-gallery" rel="useZoom:'image_zoom', smallImage:'public/images/product/800x800/4_1.jpg', adjustX:5, adjustY:-5, position:'inside'" onclick="return false" href="public/images/product/1000x1000/4_1.jpg"> <img src="public/images/product/100x100/4_1.jpg" alt="" /> </a> <a class="no-display" href="public/images/product/1000x1000/4_1.jpg" rel="lightbox[em_lightbox]">lightbox moreview</a>
                                                            </li>
                                                            <li class="item">
                                                                <a class="cloud-zoom-gallery" rel="useZoom:'image_zoom', smallImage:'public/images/product/800x800/6_1.jpg', adjustX:5, adjustY:-5, position:'inside'" onclick="return false" href="public/images/product/1000x1000/6_1.jpg"> <img src="public/images/product/100x100/6_1.jpg" alt="" /> </a> <a class="no-display" href="public/images/product/1000x1000/6_1.jpg" rel="lightbox[em_lightbox]">lightbox moreview</a>
                                                            </li>
                                                            <li class="item">
                                                                <a class="cloud-zoom-gallery" rel="useZoom:'image_zoom', smallImage:'public/images/product/800x800/5_1.jpg', adjustX:5, adjustY:-5, position:'inside'" onclick="return false" href="public/images/product/1000x1000/5_1.jpg"> <img src="public/images/product/100x100/5_1.jpg" alt="" /> </a> <a class="no-display" href="public/images/product/1000x1000/5_1.jpg" rel="lightbox[em_lightbox]">lightbox moreview</a>
                                                            </li>
                                                        </ul>
                                                    </div><!-- /.more-views -->
                                                </div>
                                                    ...
                                                    <ul id="em-upsell" class="products-grid em-upsell-slider">
                                                        <li class="item">
                                                            <div class="product-item">
                                                                <a href="#" title="Monki Metallic T-Shirt" class="product-image"> <img class="em-img-lazy img-responsive" src="public/images/product/180x180/small_image.jpg" width="180" height="180" alt="Monki Metallic T-Shirt" /> </a>
                                                        ...
                                                        <li class="item">
                                                            <div class="product-item">
                                                                <a href="#" title="Marmot PreCip Rain Jacket - Men's Tall" class="product-image"> <img class="em-img-lazy img-responsive" src="public/images/product/180x180/sport_outdoor_sp14_1.jpg" width="180" height="180" alt="Marmot PreCip Rain Jacket - Men's Tall" /> </a>
                                                                <div class="product-shop">
                                                                    <div class="f-fix">
                                                        ...
                                                        <li class="item">
                                                            <div class="product-item">
                                                                <a href="#" title="Halter Playsuit" class="product-image"> <img class="em-img-lazy img-responsive" src="public/images/product/180x180/clothing_sp16_1.jpg" width="180" height="180" alt="Halter Playsuit" /> </a>
                                                                <div class="product-shop">
                                                                    <div class="f-fix">
                                                        ...
                                                        <li class="item">
                                                            <div class="product-item">
                                                                <a href="#" title="Marmot PreCip Rain Jacket - Men's" class="product-image"> <img class="em-img-lazy img-responsive" src="public/images/product/180x180/sport_outdoor_sp16_1.jpg" width="180" height="180" alt="Marmot PreCip Rain Jacket - Men's" /> </a>
                                                                <div class="product-shop">
                                                                    <div class="f-fix">
                                                        ...
                                                        <li class="item">
                                                            <div class="product-item">
                                                                <a href="#" title="Short Sleeve 'Mom's Little Game Changer' Sports Graphic Tee " class="product-image"> <img class="em-img-lazy img-responsive" src="public/images/product/180x180/baby_14_2.jpg" width="180" height="180" alt="Short Sleeve 'Mom's Little Game Changer' Sports Graphic Tee " /> </a>
                                                                <div class="product-shop">
                                                                    <div class="f-fix">
